...
class V10DelightTimelineShowcase extends StatefulWidget {
  const V10DelightTimelineShowcase({super.key});

  @override
  State<V10DelightTimelineShowcase> createState() =>
      _V10DelightTimelineShowcaseState();
}

class _V10DelightTimelineShowcaseState
    extends State<V10DelightTimelineShowcase> {
    ...
    return Theme(
      ...
      child: StructuredTimelineScaffold(
        ...
        appBar: StructuredTimelineAppBar(
          title: 'Delight Structured Timeline',
          subtitle: _dragging
              ? 'Move the task — magnetic slots and conflicts update live'
              : '10.0.0 · magnetic drag, adaptive cards and live-app polish',
        ...
        body: Stack(
          children: <Widget>[
            DelightStructuredTimeline<_DelightTask>(
              values: _tasks,
              engine: _engine,
              selectedDate: _selectedDate,
              ...
              onDragStateChanged: (state) {
                if (_dragging != state.active) {
                  setState(() => _dragging = state.active);
                }
              },
